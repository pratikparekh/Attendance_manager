...
public class DailyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("DailyActivity",getIntent().getStringExtra("link"));
    ...
    private class AttendanceAsyncTask extends AsyncTask<String, Void, List> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(DailyActivity.this);
        @Override
        ...
        protected void onPostExecute(List list) {
            ...
            StudentAdapter adapter = new StudentAdapter(DailyActivity.this, OverallFragment.subjects);
